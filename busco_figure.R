...
# Output
my_output <- paste("tmp/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('Wormbase_Isoseq_cdhit_DNA_busco', 'Wormbase_Isoseq_cdhit_DNA_busco', 'Wormbase_Isoseq_cdhit_DNA_busco', 'Wormbase_Isoseq_cdhit_DNA_busco', 'Isoseq_DNA_busco', 'Isoseq_DNA_busco', 'Isoseq_DNA_busco', 'Isoseq_DNA_busco')
...
my_percentage <- c(57.7, 23.6, 2.7, 16.0, 22.9, 49.4, 6.6, 21.1)
my_values <- c(550, 225, 26, 153, 218, 471, 63, 202)
